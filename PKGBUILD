...
pkgbase=linux-surfacepro4       # Build kernel with a different name
_srcname=linux-4.14
pkgver=4.14.13
pkgrel=1
arch=('x86_64')
...
sha256sums=('f81d59477e90a130857ce18dc02f4fbe5725854911db1e7ba770c7cd350f96a7'
            ...
            'SKIP'
            'bdf1bd7c5f6e6f76d54a000494530d23f014e00c0d2d30fc6cfc3a5e99383386'
...
build() {
  ...
  make -j 4 ${MAKEFLAGS} LOCALVERSION= bzImage modules
}
